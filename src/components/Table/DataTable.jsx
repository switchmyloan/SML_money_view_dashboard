            ...
            <div className=" z-20  flex flex-col  w-48">
              {/* <select
                    ...
                    >
                        ...
                        <option value="Lead has been rejected">Lead has been rejected</option>
                        <option value="Duplicate User (Dedupe)">Duplicate User (Dedupe)</option>
                        <option value="Invalid data to get offer for lead">Invalid data to get offer for lead</option>
                    </select> */}
              <select
                onChange={(e) => onFilterChange(e.target.value)}
                value={activeStatusFilter}
