...
const ShortSelectedLenderDetail = () => {
  ...
  useEffect(() => {
    ...
    getShortOfferLeadByPhone(phone)
      .then((res) => {
        if (cancelled) return;
        if (res?.data?.success) {
  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold text-gray-800">Short Selected Lender — Details</h1>
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="bg-white rounded-lg shadow-sm p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-800">Offer Profile (from Short Offer Leads)</h2>
        ...
        {!offerLoading && !offerLead && !offerError && (
          <p className="text-sm text-gray-500">No matching short offer lead found for phone {phone || 'N/A'}.</p>
        )}
...
export default ShortSelectedLenderDetail;
