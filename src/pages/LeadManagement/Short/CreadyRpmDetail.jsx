...
const TimelineItem = ({ event, at, details, last }) => {
  const meta = {
    ...
    submitted:       { Icon: Sparkles,          color: 'purple', label: 'Submitted (shortOfferLeads)' },
...
const CreadyRpmDetail = () => {
  ...
  return (
    <div className="pb-10">
      ...
      >
        <ArrowLeft size={15} /> Back to Cready RPM
      </button>
      ...
      {!loading && data && attempts === 0 && (
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-5 text-sm text-amber-800">
          This phone has no entries in <span className="font-mono">short_apply_new_draft_leads</span>.
        </div>
      )}
      ...
      {!loading && data && attempts > 0 && activeTab === 'overview' && (
        <>
          ...
          {/* Call-center feedback — moved to the bottom, below All Draft Entries */}
          <div className="mb-4">
...
export default CreadyRpmDetail;
